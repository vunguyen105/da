...
jQuery(document).ready(function(){
	...
	jQuery("#form1").validate({
		...
		messages: {
                        partnername: "Vui lòng nhập tên đối tác",
                        password: "Vui lòng nhập mật khấu",
                        user: "Vui lòng nhập Tài khoản",
			firstname: "Vui lòng họ",
			lastname: "Vui lòng nhập tên",
			email: "Vui lòng nhập email",
			location: "Vui lòng nhập location",
                        timemax: jQuery.format("Giá trị từ {0} đến {1}."),
		},
