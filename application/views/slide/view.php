        ...
        <div class="portlet box light-grey">
            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="btn-group">
                        <a href="<?php echo base_url() ?>dashboard/slide_create">
                            <button id="create_user" class="btn green">
                                Thêm slide mới<i class="icon-plus"></i>
                            </button>
                    </div>
                            ...
                            <tbody>
                                ...
                                foreach ($slide as $key => $value):
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center hidden-480"><?php echo $value["file_name"]; ?></td>
                                        <td style="width:8px;"><?php echo $value["create_on"]; ?></td>
...
<script>
    ...
    jQuery(document).on('click', '.icon-edit', function() { //alert('xxxxxxxx');
        ...
        location.href = url+'dashboard/slide_edit/'+id;
...
//    });
    jQuery(document).on('click', 'table#table_user span.icon-trash', function() {
        ...
        BootstrapDialog.confirm('Thông báo', 'Bạn muốn xóa dữ liệu này', function(result) {
            if (result) {
                $.ajax({
                    type: "POST",
                    data: {
