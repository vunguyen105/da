    ...
    <div class="span12">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption"><i class="icon-globe"></i>Tạo slide</div>
                <div class="tools">
...
<script>
    ...
    jQuery(document).on('click', "#save", function() {
        BootstrapDialog.confirm('Thông báo', 'Bạn muốn tạo slide', function(result) {
            if (result) {
                        ...
                        BootstrapDialog.show({
                            ...
                            buttons: [{
                                    ...
                                    action: function() {
                                        ...
                                        location.href = url+'dashboard/slide/';
