    ...
    <div class="span12">
        ...
        <div class="portlet box green">
            ...
            <div class="portlet-title">
                <div class="caption"><i class="icon-globe"></i>Sửa slide</div>
                <div class="tools">
            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="control-group">
                        <label class="control-label" value="">Tiêu đề</label>
                        <div class="controls">
                            <input name="title" type="text" class="span6 m-wrap" value="<?php echo $slide['title']?>">                            
                        </div>
                    </div>
                    <div>
                        <select id="status">
                            <option value="1" >Hiển thị ngoài trang chủ</option>>
                            <option value="0">Không hiển thị ngoài trang chủ</option>
                        </select>
                    </div>
                    <hr class="clearfix"> 
                    ...
                    <div class="row-fluid">
                        <ul id="imges" class="listfile isotope" id="medialist" style="position: relative; overflow: hidden;">
                            <li>
                                <a class="cboxElement" data-link="<?php echo $slide['file_name']?>" href="<?php  echo base_url().'media/123/_thumbs/'.$slide['file_name'];?>">
                                        <img src="<?php  echo base_url().'media/123/_thumbs/'.$slide['file_name'];?>" alt=""></a><span class="filename"><?php  echo $slide['file_name'];?><a class="icon-trash"></a></span>
                            </li>
                        </ul>
                    </div>
            <?php }?>
...
<script>
    ...
    jQuery(document).on('click', "#save", function() {
        BootstrapDialog.confirm('Thông báo', 'Bạn muốn sửa slide', function(result) {
            if (result) {
                var title = $("input[name='title']").val();
                //var page = $("#standard").val();
                var status = $("#status option:selected").val();
                //alert(status);
                //var objEditor = CKEDITOR.instances["demo"];
                //var file_name = objEditor.getData();
                var array_anh = [];
                $('#imges').each(function() {
                    var link = '';
                    ...
                    success: function(data) {
                        BootstrapDialog.show({
                            ...
                            buttons: [{
                                    ...
                                    hotkey: 13, // Enter.
                                    action: function() {
                                        location.href = "<?php echo base_url()?>dashboard/slide";
