        ...
        <div class="portlet box light-grey">
            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="btn-group">
                        <a href="<?php echo base_url()?>dashboard/product_create"><button id="create_user" class="btn green">
                            Thêm sản phẩm mới
                        </button>
                        </a>    
                    </div>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="table_user">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td style="width:8px;"><?php echo $value["pro_name"]; ?></td>
                                <td class="hidden-480" value="<?php echo $value['cat_id']?>"><?php echo $cats[$value['cat_id']]["name"]; ?></td>
                                <td class="center hidden-480"><?php echo $value["description"]; ?></td>
                                <td class="center hidden-480"><?php echo $value["price"]; ?></td>
