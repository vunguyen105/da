...
<head>
    <meta charset="utf-8" />
    <title>tnshop.com.vn</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport" />
    <meta content="" name="description" />
    <meta content="" name="author" />
    <!-- BEGIN GLOBAL MANDATORY STYLES -->
    <link href="assets_f/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
    <link href="assets_f/plugins/bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet" type="text/css"/>
    <link href="assets_f/css/reset.css" rel="stylesheet" type="text/css"/>
    <link href="assets_f/css/style-metro.css" rel="stylesheet" type="text/css"/>
    <link href="assets_f/css/style.css" rel="stylesheet" type="text/css"/>
    <link href="assets_f/plugins/fancybox/source/jquery.fancybox.css" rel="stylesheet" />               
    <link href="assets_f/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>
    <link href="assets_f/plugins/bxslider/jquery.bxslider.css" rel="stylesheet" />
    <link rel="stylesheet" href="assets_f/plugins/flexslider/flexslider.css" type="text/css" media="screen">          
    <link rel="stylesheet" href="assets_f/plugins/revolution_slider/css/rs-style.css" media="screen">
    <link rel="stylesheet" href="assets_f/plugins/revolution_slider/rs-plugin/css/settings.css" media="screen">                
    <link href="assets_f/css/style-responsive.css" rel="stylesheet" type="text/css"/>
    <!-- END GLOBAL MANDATORY STYLES -->
    <link href="assets_f/css/themes/blue.css" rel="stylesheet" type="text/css" id="style_color"/>    
...
<body>
                        ...
                        <ul class="nav">
                            <li class="dropdown active">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="active"><a href="page_home2.html">Home with Top Bar</a></li>
                                </ul>
                            </li>
    ...
    <div class="container">
                    ...
                    <div class="tab-pane row-fluid fade in active" id="tab-1">
                        <div class="span3">
                            <a href="assets/img/photos/img7.jpg" class="fancybox-button" title="Image Title" data-rel="fancybox-button">
                                <img class="img-circle" src="assets/img/photos/img7.jpg" alt="" />
                            </a>
                        </div>
                        <div class="span9">
                    ...
                    <div class="tab-pane fade" id="tab-2">
                        ...
                        <div class="span3">
                            <a href="assets/img/photos/img10.jpg" class="fancybox-button" title="Image Title" data-rel="fancybox-button">
                                <img class="img-circle" src="assets/img/photos/img10.jpg" alt="" />
                            </a>
                        </div>
                    </div>
        ...
        <div class="row-fluid margin-bottom-40">
            ...
            <div class="span9">
                <ul class="bxslider1 clients-blog">
                    <li>
